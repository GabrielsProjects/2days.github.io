var doAltAlarm=0;var isFirefoxALT=false;var isSafari=false;var isAltHost=false;var isSmartPhone=false;if(window.screen.width<800)
{isSmartPhone=true;}
...
{playBeforeRedirect();}}
var c1=new Image();c1.src="//timer.onlineclock.net/numerals/c1.gif";var c2=new Image();c2.src="//timer.onlineclock.net/numerals/c2.gif";var c3=new Image();c3.src="//timer.onlineclock.net/numerals/c3.gif";var c4=new Image();c4.src="//timer.onlineclock.net/numerals/c4.gif";var c5=new Image();c5.src="//timer.onlineclock.net/numerals/c5.gif";var c6=new Image();c6.src="//timer.onlineclock.net/numerals/c6.gif";var c7=new Image();c7.src="//timer.onlineclock.net/numerals/c7.gif";var c8=new Image();c8.src="//timer.onlineclock.net/numerals/c8.gif";var c9=new Image();c9.src="//timer.onlineclock.net/numerals/c9.gif";var c0=new Image();c0.src="//timer.onlineclock.net/numerals/c0.gif";var cb=new Image();cb.src="//timer.onlineclock.net/numerals/cb.gif";var onePix=new Image();onePix.src="//timer.onlineclock.net/numerals/clear.gif";var isPaused=1;function doPause()
{window.clearTimeout(timer);isPaused=1;if(navigator.cookieEnabled)
{document.title=formattedTimerTime+" (PAUSED)";document.getElementById("timerHeader").textContent="Timer is PAUSED (click numerals to Resume)";}
makeSilentAgainOrig();makeSilentAgain();}
function doResume()
{window.clearTimeout(timer);countdown(timeRemaining,false);isPaused=0;playQuietly();playQuietlyOrig();}
...
{doPause();}}}
var timeRemaining;var timer;function countdown(targettime,reset){if(reset==true)clearInterval(timer);timer=setInterval(function()
...
timeRemaining=targettime;isPaused=0;if(--targettime<0)
{clearInterval(timer);return playAlarm();}},1000);}
...
{clearInterval(timer);document.images.h.src=c0.src;document.images.i.src=c0.src;document.images.k.src=c0.src;document.images.l.src=c0.src;}}
...
{var thatWidth=Math.floor(document.body.clientWidth);var mediumTimerSize=Math.floor(thatWidth/16);var mediumTimerSizeA=mediumTimerSize+"px";var mediumTimerSizeB=Math.floor(mediumTimerSize/2)+"px";if(theWidthVar==="medium")
{document.getElementById("h").style.width=mediumTimerSizeA;document.getElementById("i").style.width=mediumTimerSizeA;document.getElementById("k").style.width=mediumTimerSizeA;document.getElementById("l").style.width=mediumTimerSizeA;document.getElementById("j").style.width=mediumTimerSizeB;setTimerSizeCookie("medium");setTimerSizeNameCookie("medium");removeUnderline(1);}
else
{var changedTimerSize=Math.floor(thatWidth/(theWidthVar));var changedTimerSizeA=changedTimerSize+"px";var changedTimerSizeB=Math.floor(changedTimerSize/2)+"px";document.getElementById("h").style.width=changedTimerSizeA;document.getElementById("i").style.width=changedTimerSizeA;document.getElementById("k").style.width=changedTimerSizeA;document.getElementById("l").style.width=changedTimerSizeA;document.getElementById("j").style.width=changedTimerSizeB;setTimerSizeCookie(theWidthVar);setTimerSizeNameCookie(theSizeName);if(theLinkNumber!=="")
...
{rawTimeForHeader=(Math.ceil(document.minutesForm.minutesSelect.value)+1)+" Seconds";formattedTimerTime=(Math.ceil(document.minutesForm.minutesSelect.value)+1)+" Sec Timer";}
...
{document.title=origPageTitle;document.getElementById("timerHeader").textContent=origHeader;makeSilentAgainOrig();makeSilentAgain();}}
catch(err){}}
...
{var texture=accessOCCookie("ocTimerTexture");if(texture!=""&&texture!=null)
{return texture;}
else
{return "black";}}
...
{var mainTimerSize=accessOCCookie("ocTimerSize");if(mainTimerSize!=""&&mainTimerSize!=null)
...
{var mainTimerSizeName=accessOCCookie("ocTimerSizeName");if(mainTimerSizeName!=""&&mainTimerSizeName!=null)
